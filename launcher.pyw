...
try:
    import ctypes
    ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID('HyperHotkey.Automation.v2.2.4')
except Exception:
    pass
...
root = tk.Tk()
root.title("HyperHotkey v2.2.4 Launcher")
