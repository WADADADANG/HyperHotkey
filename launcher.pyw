...
try:
    import ctypes
    ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID('HyperHotkey.Automation.v2.2.2')
except Exception:
    pass
...
root = tk.Tk()
root.title("HyperHotkey v2.2.2 Launcher")
